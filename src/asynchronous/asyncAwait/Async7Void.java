...
public class Async7Void<T1, T2, T3, T4, T5, T6, T7> implements HeptaFunction<T1, T2, T3, T4, T5, T6, T7, Promise<Void>>{
	private final Async7<T1, T2, T3, T4, T5, T6, T7, Void> async;
	
	public Async7Void(OctoConsumer<Async.Await, T1, T2, T3, T4, T5, T6, T7> func, String name) {
		async = new Async7<T1, T2, T3, T4, T5, T6, T7, Void>(
